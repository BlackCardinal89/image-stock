...
(function(halyk) {
    ...
    var testConfig = {
        pageUrL : "https://epay-staging.homebank.kz/payform/",
        origin: "https://epay-staging.homebank.kz",
        TokenAPIConfig : {
    ...
    function addCssClass() {
        ...
        style.type = "text/css";
        var styleClasses = ".widgetScreen {position: absolute; top: 0; bottom: 0; left: 0; right: 0; z-index: 1000; background-color: rgba(5, 5, 5, 0.5);}";
        styleClasses += ".iframeBox{border-radius: 4px; position: absolute; width: 420px; height: 720px; z-index: 1010; top: 50%; left: 50%; margin: -360px 0 0 -210px; background-color: #fff; padding: 10px;}";
        styleClasses += ".iframeBoxHeader{height: 20px; padding: 0px;}";
        ...
        styleClasses += ".iframeHolder{ width:  100%; height: 690px; }";
    ...
    function showPaymentWidget(params, callBack) {
            ...
            if (!widgetNode) {
                ...
                iframeBoxCloseButton.addEventListener("click", function() { onCloseDialog(false); });
                ...
                iframe.src = pageUrl + "?params=" + LZString.compressToEncodedURIComponent(encodeParams(params)) + '&isShortForm=true';
